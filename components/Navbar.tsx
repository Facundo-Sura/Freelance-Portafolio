  ...
  return (
    <nav
      className={cn(
        ...
        isScrolled ? "bg-glass py-2" : "bg-transparent"
      )}
    >
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            className="md:hidden bg-background/95 backdrop-blur-md absolute top-full left-0 right-0 border-b border-white/10"
          >
